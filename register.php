...
<h1 style="color:white">SINGN UP</h1> 
        
        <h>Please fill this form to create an account.</h><br>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="center"><br><br>
            <div class="form-group <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
                <label>USERNAME</label>
                <input class="ewoi" type="text" name="username" class="form-control" value="<?php echo $username; ?>"><br><br><br>
                <span class="help-block"><?php echo $username_err; ?></span>
            </div>    
            <div class="form-group <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
                <label>PASSWORD</label>
                <input class="ewoi" type="password" name="password" class="form-control" value="<?php echo $password; ?>" ><br><br><br>
                <span class="help-block"><?php echo $password_err; ?></span>
            </div>
            <div class="form-group <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>">
                <label>CONFIRM PASSWORD</label>
                <input class="ewoi" type="password" name="confirm_password" class="form-control" value="<?php echo $confirm_password; ?>"><br><br><br>
                <span class="help-block"><?php echo $confirm_password_err; ?></span>
            </div>
            <div class="form-group">
                <input type="submit" class="button" value="Sign UP">
                <input type="reset" class="button" value="Reset"><br><br><br><br><br><br>
        ...
        <br><br> <p> <b>ALL READY HAVE AN ACCOUNT?</b><br> <a href="login.php" class="button">Login here</a>.</p>
        </center> <br>
